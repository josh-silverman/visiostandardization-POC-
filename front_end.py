...
st.title("PNG Shape Analysis with Azure OpenAI GPT-4o")

st.markdown("""
Upload a PNG diagram and let GPT-4o Vision analyze it for you.
""")
...
if uploaded_file is not None:
    ...
    # 3. Option to analyze with GPT-4o
    question = st.text_input("Ask a question about the image:",
        "How many shapes are in this image? What are the different types of shapes?")

    # Always append JSON instruction
    json_instruction = (
        "In addition to your answer, return a JSON object that describes the process in the image. "
    ...
    if st.button("Analyze with GPT-4o Vision"):
        ...
        with st.spinner("Sending image to Azure OpenAI GPT-4o..."):
            try:
                ...
                answer = response['choices'][0]['message']['content']
                st.markdown("**GPT-4o's JSON Output:**")
